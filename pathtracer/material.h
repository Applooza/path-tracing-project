...
public:
	...
	//virtual float get_pdf(const vec3& wi, const vec3& wo, const vec3& n) = 0;
	virtual float get_pdf(const vec3& wi, const vec3& wo, const vec3& n, float& p) = 0;
...
public:
	...
	//virtual float get_pdf(const vec3& wi, const vec3& wo, const vec3& n) override;
	virtual float get_pdf(const vec3& wi, const vec3& wo, const vec3& n, float& p) override;
